...
EXPERIMENT_NAME="debug_for_multi_node"
# export CUDA_VISIBLE_DEVICES=4,5,6,7
export SAVE_CHECKPOINT_DIR=/app/verl_checkpoints
...
export LLM_AS_A_JUDGE_BASE="http://172.18.148.44:18901/v1"
export VLLM_USE_TRITON_FLASH_ATTN=0
export HSA_FORCE_FINE_GRAIN_PCIE=1 
export RAY_TMPDIR=/app/xiaominl/deepeye/ray_tmp
