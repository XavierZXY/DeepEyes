export ROCR_VISIBLE_DEVICES=0,1,2,4,5
PROJECT_NAME="iad-grounding-tool"
EXPERIMENT_NAME="debug_for_tool_mi300"
WORLD_SIZE=1
export SAVE_CHECKPOINT_DIR=/home/takisobe@amd.com/zxy/codes/DeepEyes/data/models
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.optim.lr=2.5e-7 \
