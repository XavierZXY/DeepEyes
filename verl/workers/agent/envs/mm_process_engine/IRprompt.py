class PROMPT():
    ...
    USER_PROMPT_V1 = "The `{tool_name}` tool was applied successfully. Please analyze the new image for any remaining degradations according to the restoration principle."
