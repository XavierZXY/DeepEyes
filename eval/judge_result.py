...
parser.add_argument('--api_url', type=str, default='http://localhost:18902/v1', help='API URL')
parser.add_argument('--vstar_bench_path', type=str, default='/app/datasets/vstar_bench', help='Path to the V* benchmark')
parser.add_argument('--save_path', type=str, default='./results', help='Path to save the results')
parser.add_argument('--eval_model_name', type=str, default='/app/models/Qwen2.5_VL_72B_Instruct', help='Model name for evaluation')
