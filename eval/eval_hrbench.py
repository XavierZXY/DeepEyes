...
parser = argparse.ArgumentParser()
parser.add_argument('--model_name', type=str, default='Qwen2.5_VL_7B_step10_hrbench', help='Model name for result save')
parser.add_argument('--api_key', type=str, default='EMPTY', help='API key')
parser.add_argument('--api_url', type=str, default='http://localhost:18901/v1', help='API URL')
parser.add_argument('--hrbench_path', type=str, default='/app/datasets/HR-bench', help='Path to the V* benchmark')
